...
from models.detection.lstm_attention.train import main_training_loop
#universl librries import
import json
import os

#config import
from config import DATA_PAATH,  MODEL_SAVE_PATH, GLOVE_PATH, VOCAB_PATH

if __name__ == "__main__":
    if __name__ == "__main__":
        injection_save_path = MODEL_SAVE_PATH / "injected_data/heuristics.json"
        detection_save_path = MODEL_SAVE_PATH / "lstm_attention/model.pt"
        vocab_path = VOCAB_PATH / "lstm_attention.json"
        ...
        main_training_loop(data,GLOVE_PATH,vocab_path,detection_save_path, hidden_dim=128, epochs=20)

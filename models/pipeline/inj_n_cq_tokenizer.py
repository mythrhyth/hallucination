...
from models.detection.lstm_with_tokenizer_emb_cq.train import train_model
#universl librries import
import json
import os

#config import
from config import DATA_PAATH,  MODEL_SAVE_PATH

if __name__ == "__main__":
    if __name__ == "__main__":
        injection_save_path = MODEL_SAVE_PATH / "injected_data/heuristics.json"
        detection_save_path = MODEL_SAVE_PATH / "lstm_cq_tokenizer/model.pt"
        ...
        train_model(data,detection_save_path)
